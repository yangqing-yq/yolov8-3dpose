...
def scale_euler(euler_3d, euler_distribution):
    euler_mean = torch.tensor(euler_distribution['mean']).cuda()
    euler_std = torch.tensor(euler_distribution['std']).cuda()
    scaled_euler_3d = euler_3d * euler_std + euler_mean

    return scaled_euler_3d
