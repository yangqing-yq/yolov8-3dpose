...
from utils.preprocessing_hand import load_img, process_bbox, augmentation, process_human_model_output
...
class FreiHAND(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        # self.data_path = osp.join('/datahdd/wyz/workspace/mocap_optim/hand_mocap_train/datasets/FreiHAND', 'data')
        # self.human_bbox_root_dir = osp.join('/datahdd/wyz/workspace/mocap_optim/hand_mocap_train/datasets/FreiHAND', 'rootnet_output', 'bbox_root_freihand_output.json')
    ...
    def print_eval_result(self, eval_result):
        output_save_path = osp.join('results', 'FreiHAND')
