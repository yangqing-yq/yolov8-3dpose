...
import sys
sys.path.insert(1, '/dc/yolo3dpose/yolov8-3dpose/body-tracking')
...
class MPII(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.img_path = osp.join('/data/coco_human/3d_angles/train', 'train_ubody')
        self.annot_path = osp.join('/data/ubody_annotations/ConductMusic')
